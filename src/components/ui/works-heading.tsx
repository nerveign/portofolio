    ...
    <>
      <div className="W-[27rem] border-b-1 mb-2">
        ...
        <div className="mt-2 lg:mt-3 text-zinc-600 dark:text-[#A5A3A3]">
          <p className="text-sm lg:text-base">Projects I've built while exploring new technologies, solving real-world problems, and growing as a software developer.</p>
        </div>
