        ...
        <div className="mt-3 lg:mt-4 text-zinc-600 dark:text-[#A5A3A3]">
          ...
          <div className="flex gap-4 items-center mt-2 lg:mt-3">
            <div className="flex gap-2 md:gap-4 items-center mt-2">
              <div className="size-10 flex justify-center items-center text-blue-500 bg-blue-500/10 rounded-full p-1">
                <Mail className="size-5 text-blue-500" />
              </div>
              <div className="flex flex-col gap-0.5">
                <h3 className="font-semibold text-gray-900">Email</h3>
                <p className="text-sm font-medium text-stone-500 dark:text-white">riszqofathur@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
