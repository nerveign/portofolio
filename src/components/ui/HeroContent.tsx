    ...
    <>
      <div className="animate-fade-in">
        <div className="text-center lg:text-start lg:w-[472px]">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold mt-3 lg:mt-4 text-center">FATHURRIZQO</h1>
          <p className="mt-3 lg:mt-5 text-zinc-700 text-center">On my way to persue happines. I love computer science, religion and also philosophy.</p>
        </div>
